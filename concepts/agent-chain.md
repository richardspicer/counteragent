...
- **Embed-Ject** (Canary Program) handles RAG retrieval poisoning. agent-chain may incorporate RAG poisoning as a step in broader chains but does not implement the retrieval optimization itself.
